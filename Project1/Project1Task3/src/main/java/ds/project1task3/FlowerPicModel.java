 ...
 */
public class FlowerPicModel extends PicModel {

    final String webURL = "https://en.wikipedia.org/wiki/List_of_U.S._state_and_territory_flowers";
    ...
    public Map<String, String> doSearch(String searchTag) throws IOException {
        ...
        // The searchTag is the state name
        Document doc = Jsoup.connect(webURL).get();
        Elements rows = doc.select("tr:has(td:contains(" + searchTag + "))");
        // Process each <tr> as needed
